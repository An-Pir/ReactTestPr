...
const RegistrationPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const usersData = [{ email: email, password: password , isAgreed: isAgreed}];
  ...
  return (
    <PageWrap>
      <Form onSubmit={handleSubmit}>
        ...
        {passwordMessage && <p className="error-text">{passwordMessage}</p>}
        ...
        <InputWrap className="input-wrap checkbox">
          <Label
            htmlFor="checkbox"
            labelTitle="согласен на обработку персональных данных"
          />
          <Input
